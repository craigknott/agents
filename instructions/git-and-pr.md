...
- Honor repository commit policies in every commit, including commits generated by automated fix or delivery steps.
  ...
  author. Before publishing, verify the complete pull-request commit range. If DCO fails, amend or rebase every unsigned
  commit with the matching sign-off; a later signed commit does not remediate an earlier unsigned commit. A
